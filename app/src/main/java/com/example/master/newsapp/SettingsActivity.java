        ...
        btnDelete.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(deletedRows > 0)
                            Toast.makeText(SettingsActivity.this,"Data Deleted",Toast.LENGTH_LONG).show();
                        else
                            Toast.makeText(SettingsActivity.this,"Data not Deleted",Toast.LENGTH_LONG).show();
                    }
                }
        );
    }
        ...
        btnviewUpdate.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(isUpdate == true)
                            Toast.makeText(SettingsActivity.this,"Data Update",Toast.LENGTH_LONG).show();
                        else
